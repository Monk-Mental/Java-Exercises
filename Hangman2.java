    ...
    public static void main(String[] args) {
     ...
     do{
        ...
        while((incorrectGuesses<7)&&(numDashes(formattedSecretString)>0)){
            ...
            System.out.println("\n"+"Enter 'l' (without a space at the end) if you want to guess letters or hit anything else and enter to guess the sentence");
            ...
            if(letterOrSentence.equals("l")){
                ...
                System.out.println("Guess the sentence!");     
